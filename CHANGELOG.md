...
- **`SECURITY.md` top-of-file navigation block** ([#192](https://github.com/yottayoshida/omamori/pull/192)): index links to the principal sections (invariants / known limitations / scope / threat model / audit chain) so readers can jump to a subsection without scrolling.
